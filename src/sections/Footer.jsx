            ...
            <div className='d-flex flex- row'>
              <div className='col-md-3 col-lg-3 col-sm-12 px-2 mx-auto'>
                <Anchor className='p-0' to='' style={{ marginBottom: '-35px' }}>
                  <img id='image' src={require('../images/logo1png.png')} alt='logo' style={{ padding: '0px', height: '8rem', weight: '8rem' }} />
                </Anchor>
                    <br></br>
                    <br></br>
                    <br></br>
                <p>A simple way to interact   with speed and analytics.</p>
              ...
              <div className='col-md-6 col-lg-6 col-sm-12 mx-auto px-2'>
                ...
                <p className='text-justify'>We've designed Interactive marketing tool  with a desire to help companies to grow faster by taking control of one the most crucial thing in business – interaction with clients before spending, purchasing of goods, works from external source. Interactive marketing tool  is here to help you to control the purchasing process and reduce manual work with a simple and powerful cloud solution.</p>
