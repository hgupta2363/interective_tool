            ...
            <div className="align-items-center justify-content-center">
              ...
              <div className="col-sm-12 col-xs-12 align-items-center justify-content-center align-center row m-0 p-0">
                <div className="d-flex flex-column col-lg-3 mx-auto col-sm-10 features-container justify-content-center p-3 my-2">
                  ...
                  Interactive Marketing tool  is a robust and easy to deploy interaction system for your business and business needs . A flexible workflow system that enables all stakeholders to contribute and interact without hassles.
                  </p>
                </div>
                <div className="d-flex flex-column col-lg-3 justify-content-center mx-auto col-sm-10 features-container p-3 my-2">
                  ...
                  <p className="h5 my-3">
                  Quick interaction and tool execution.
                  </p>
                  <p className="text-justify">
                  Speed up your interaction system by implementing Interactive management tool, executing interaction process easily and control your expenditures on goods with other available resources.
                  </p>
                </div>
                <div className="d-flex flex-column col-lg-3 justify-content-center mx-auto col-sm-10 features-container p-3 my-2">
...
Easy to interact and manage your daily goods, services and keep a track on your  history and allow you to access more features and compare with old history and get available recommendations.
