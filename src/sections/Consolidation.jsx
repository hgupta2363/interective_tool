      ...
      <Router>
        ...
        >
          <div className='row col-lg-10 justify-content-center d-flex align-items-center p-0 m-0 custom-section'>
            ...
            Consolidate and control all interactions from source to pay and other services 
            </p>
            <p className='h6 product-intro font-weight-regular py-4'>
            With Interactive mangement tool  interact and manage solutions, you can digitize and simplify all your processes end-to-end, on a single, integrated platform in the cloud.
            </p>
            ...
            <div className='col-sm-12 align-items-center justify-content-center align-center row m-0 p-0'>
              <div className='d-flex flex-column col-lg-3 justify-content-center mx-auto col-sm-10 consolidate-container p-3 my-3'>
                ...
                Make higher sourcing choices with interaction analysis insights. negotiate best-value agreements for savings on each direct and indirect materials,services and goods. Minimize risk and accelerate the lifecycle with intrinsic  management and interaction..
                </p>
              ...
              <div className='d-flex flex-column col-lg-3 justify-content-center mx-auto col-sm-10 consolidate-container p-3 my-3'>
                ...
                <p className='text-justify font-weight-regular'>
                Increase interaction and guaranteed compliance mistreatment the market’s broadest set of e-interaction process and answer capabilities. Lead workers to most well-liked suppliers with a straightforward, target-hunting interaction for expertise. interact with all suppliers simply and with confidence.
                </p>
                <Link to='#'>Read more -></Link>
              </div>
              <div className='d-flex flex-column col-lg-3 justify-content-center mx-auto col-sm-10 consolidate-container p-3 my-3'>
                ...
                <p className='text-justify font-weight-regular'>
                Transform liabilities into strategic assets. automatize interaction capture, workflow, and approval. give interactors visibility into payments. Improve interaction  whereas reducing provide chain prices and liquidity risk.
                </p>
                <Link to='#'>Read more -></Link>
              </div>
            </div>
